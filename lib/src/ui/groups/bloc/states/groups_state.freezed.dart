...
abstract class Loading implements GroupsState {
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(final List<Group> groups) : _groups = groups;
...
abstract class Loaded implements GroupsState {
  const factory Loaded(final List<Group> groups) = _$LoadedImpl;
...
class __$$ActionSuccessImplCopyWithImpl<$Res>
    extends _$GroupsStateCopyWithImpl<$Res, _$ActionSuccessImpl>
...
class _$ActionSuccessImpl implements ActionSuccess {
  ...
  @override
  String toString() {
    return 'GroupsState.actionSuccess(message: $message)';
  }
...
abstract class ActionSuccess implements GroupsState {
...
abstract class Error implements GroupsState {
