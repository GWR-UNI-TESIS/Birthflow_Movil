...
part of 'childbirth_note_request.dart';
...
ChildbirthNoteRequest _$ChildbirthNoteRequestFromJson(
    Map<String, dynamic> json) {
  return _ChildbirthNoteRequest.fromJson(json);
}
...
mixin _$ChildbirthNoteRequest {
  ...
  /// Serializes this ChildbirthNoteRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ChildbirthNoteRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ChildbirthNoteRequestCopyWith<ChildbirthNoteRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ChildbirthNoteRequestCopyWith<$Res> {
  factory $ChildbirthNoteRequestCopyWith(ChildbirthNoteRequest value,
          $Res Function(ChildbirthNoteRequest) then) =
      _$ChildbirthNoteRequestCopyWithImpl<$Res, ChildbirthNoteRequest>;
  @useResult
  $Res call(
      {String partographId,
      String? description,
...
/// @nodoc
class _$ChildbirthNoteRequestCopyWithImpl<$Res,
        $Val extends ChildbirthNoteRequest>
    implements $ChildbirthNoteRequestCopyWith<$Res> {
  _$ChildbirthNoteRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ChildbirthNoteRequestImplCopyWith<$Res>
    implements $ChildbirthNoteRequestCopyWith<$Res> {
  factory _$$ChildbirthNoteRequestImplCopyWith(
          _$ChildbirthNoteRequestImpl value,
          $Res Function(_$ChildbirthNoteRequestImpl) then) =
      __$$ChildbirthNoteRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String partographId,
...
/// @nodoc
class __$$ChildbirthNoteRequestImplCopyWithImpl<$Res>
    extends _$ChildbirthNoteRequestCopyWithImpl<$Res,
        _$ChildbirthNoteRequestImpl>
    implements _$$ChildbirthNoteRequestImplCopyWith<$Res> {
  __$$ChildbirthNoteRequestImplCopyWithImpl(_$ChildbirthNoteRequestImpl _value,
      $Res Function(_$ChildbirthNoteRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ChildbirthNoteRequestImpl(
      partographId: null == partographId
          ? _value.partographId
          : partographId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$ChildbirthNoteRequestImpl implements _ChildbirthNoteRequest {
  ...
  factory _$ChildbirthNoteRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$ChildbirthNoteRequestImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ChildbirthNoteRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ChildbirthNoteRequestImplCopyWith<_$ChildbirthNoteRequestImpl>
      get copyWith => __$$ChildbirthNoteRequestImplCopyWithImpl<
          _$ChildbirthNoteRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ChildbirthNoteRequestImplToJson(
      this,
    );
  }
}

abstract class _ChildbirthNoteRequest implements ChildbirthNoteRequest {
  const factory _ChildbirthNoteRequest(
      ...
      required final String huellaDig}) = _$ChildbirthNoteRequestImpl;

  factory _ChildbirthNoteRequest.fromJson(Map<String, dynamic> json) =
      _$ChildbirthNoteRequestImpl.fromJson;
