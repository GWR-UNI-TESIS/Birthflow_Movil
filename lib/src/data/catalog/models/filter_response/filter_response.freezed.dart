...
mixin _$FilterResponse {
  ...
  /// Serializes this FilterResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of FilterResponse
...
/// @nodoc
@JsonSerializable()
class _$FilterResponseImpl implements _FilterResponse {
  const _$FilterResponseImpl({required this.id, required this.description});
  ...
  @override
  String toString() {
    return 'FilterResponse(id: $id, description: $description)';
  }
...
abstract class _FilterResponse implements FilterResponse {
  const factory _FilterResponse(
      {required final int id,
      required final String description}) = _$FilterResponseImpl;
