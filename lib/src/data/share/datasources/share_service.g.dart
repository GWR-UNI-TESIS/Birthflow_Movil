...
class _ShareService implements ShareService {
  _ShareService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<List<SearchUserGroupResponse>>> getSearchUserGroup(
    ...
    final _options = _setStreamType<ApiResponse<List<SearchUserGroupResponse>>>(
    ...
    try {
      _value = ApiResponse<List<SearchUserGroupResponse>>.fromJson(
        ...
        (json) => json is List<dynamic>
            ? json
                .map<SearchUserGroupResponse>(
                  (i) => SearchUserGroupResponse.fromJson(
  ...
  Future<ApiResponse<AsignUserGroupResponse>> asignUsersGroups(
    ...
    final _options = _setStreamType<ApiResponse<AsignUserGroupResponse>>(
  ...
  Future<ApiResponse<PartographShareResponse>> createPartographShare(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<ApiResponse<PartographShareResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<ApiResponse<List<GroupResponse>>> getGroups(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<GroupResponse>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/share/groups',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<GroupResponse>> _value;
    try {
      _value = ApiResponse<List<GroupResponse>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<GroupResponse>(
                  (i) => GroupResponse.fromJson(i as Map<String, dynamic>),
                )
                .toList()
            : List.empty(),
      );
  ...
  Future<ApiResponse<GroupResponse>> createGroup(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<ApiResponse<GroupResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<ApiResponse<List<UserAuthentication>>> getUsersInGroup(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<UserAuthentication>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/share/group/item',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<UserAuthentication>> _value;
    try {
      _value = ApiResponse<List<UserAuthentication>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<UserAuthentication>(
                  (i) => UserAuthentication.fromJson(
                    i as Map<String, dynamic>,
                  ),
                )
                .toList()
  ...
  Future<ApiResponse<UserGroupResponse>> createUserGroup(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = request;
    final _options = _setStreamType<ApiResponse<UserGroupResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/share/group/item/create',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<UserGroupResponse> _value;
    try {
      _value = ApiResponse<UserGroupResponse>.fromJson(
        _result.data!,
        (json) => UserGroupResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<ApiResponse<PartographGroupItemResponse>> createPartographGroupItem(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<ApiResponse<PartographGroupItemResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/share/partograph-group-item',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ApiResponse<List<PartographGroupResponse>>> getPartographGroups(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<PartographGroupResponse>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/share/partograph-groups',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<PartographGroupResponse>> _value;
    try {
      _value = ApiResponse<List<PartographGroupResponse>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<PartographGroupResponse>(
                  (i) => PartographGroupResponse.fromJson(
                    i as Map<String, dynamic>,
                  ),
                )
                .toList()
  ...
  Future<ApiResponse<PartographGroupResponse>> createPartographGroup(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<ApiResponse<PartographGroupResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<ApiResponse<PartographGroupShareResponse>> createPartographGroupShare(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = body;
    final _options = _setStreamType<ApiResponse<PartographGroupShareResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
