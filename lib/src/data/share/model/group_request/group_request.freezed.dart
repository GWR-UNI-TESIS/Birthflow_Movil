...
class _$GroupRequestImpl implements _GroupRequest {
  const _$GroupRequestImpl({required this.id, required this.groupName});
  ...
  @override
  String toString() {
    return 'GroupRequest(id: $id, groupName: $groupName)';
  }
...
abstract class _GroupRequest implements GroupRequest {
  const factory _GroupRequest(
      ...
      required final String groupName}) = _$GroupRequestImpl;
