...
class _AccountService implements AccountService {
  ...
  Future<ApiResponse<UserAuthentication>> requestResetCode(
    ...
    final _data = request;
    final _options = _setStreamType<ApiResponse<UserAuthentication>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/account/request-reset-code',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<ApiResponse<String>> validateOtp(ValidateOtpRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
