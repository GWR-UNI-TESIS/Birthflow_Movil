...
@freezed
abstract class PresentationPositionVarietyLog
    with _$PresentationPositionVarietyLog {
...
abstract class ChildbirthNoteLog with _$ChildbirthNoteLog {
  factory ChildbirthNoteLog({
    ...
    String? description,
    @JsonKey(name: 'Date', fromJson: _stringFromJson) required String date,
    ...
    @JsonKey(name: 'Peso', fromJson: _stringFromJson) required String peso,
