...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({String statusMessage, T? response, String status});
}
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  const _$ApiResponseImpl(
      {required this.statusMessage, this.response, required this.status});
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(statusMessage: $statusMessage, response: $response, status: $status)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, statusMessage,
      const DeepCollectionEquality().hash(response), status);
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      ...
      final T? response,
      required final String status}) = _$ApiResponseImpl<T>;
