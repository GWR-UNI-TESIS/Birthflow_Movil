...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({int statusCode, String message, T? response});
}
...
// Objeto de datos de la respuesta (requerido)
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(statusCode: $statusCode, message: $message, response: $response)';
  }
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      ...
      final T? response}) = _$ApiResponseImpl<T>;
